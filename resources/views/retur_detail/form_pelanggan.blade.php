<x-modal id="form-pelanggan" size="modal-lg" data-backdrop="static" data-keyboard="false">
    ...
    <x-slot name="footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="batalpelanggan()">Batal</button>
